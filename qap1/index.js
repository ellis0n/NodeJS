...
// Methods allow us to (among other things): access the file name and its extension type; parse path strings from objects (and vice-versa); normalize file structure...
